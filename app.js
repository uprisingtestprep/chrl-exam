/* CHRL Exam Simulator — Application Logic */

const ACCESS_CODE  = "CHRL9000";
const EXAM_SECONDS = 18000;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "chrl_exam_state_v1";
...
function keyHandler(e) {
  ...
  const q = questions[state.current - 1];
  if (["A","B","C","D"].includes(letter) && !e.ctrlKey && !e.metaKey && q?.options?.[letter]) {
